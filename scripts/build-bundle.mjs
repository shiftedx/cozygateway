...
const windowsHelper = "dist-bundle/cozygateway-windows-helper.ps1";
writeFileSync(windowsHelper, readFileSync("scripts/cozygateway-windows-helper.ps1"));
...
for (const asset of [pluginArchive, installer, windowsBootstrap, windowsHelper, posixBootstrap]) {
