...
| `bots` | array | refused | Refused at load. This gateway hosts no CozyAgents runtime bots; a CozyAgents bot's `bots` row belongs in the config of CozyAgents' bundled gateway. |
